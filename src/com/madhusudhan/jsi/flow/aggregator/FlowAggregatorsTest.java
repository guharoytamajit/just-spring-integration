...
public class FlowAggregatorsTest {
	private ApplicationContext ctx = null;

	private MessageChannel inChannel = null;

	public FlowAggregatorsTest() {
		ctx = new ClassPathXmlApplicationContext("flow-aggregators-beans.xml");
	...
	public static void main(String[] args) {
		FlowAggregatorsTest test = new FlowAggregatorsTest();
