package com.madhusudhan.jsi.flow.resequencer;
...
public class FlowResequencersTest {
	private ApplicationContext ctx = null;

	private MessageChannel inChannel = null;

	public FlowResequencersTest() {
		ctx = new ClassPathXmlApplicationContext("flow-resequencers-beans.xml");
	...
	public static void main(String[] args) {
		FlowResequencersTest test = new FlowResequencersTest();
